...
func newConfig(db *gorm.DB) config {
	...
	_config.CreatedTime = field.NewTime(tableName, "created_time")
	_config.UpdatedTime = field.NewTime(tableName, "updated_time")
	_config.DeletedTime = field.NewTime(tableName, "deleted_time")
