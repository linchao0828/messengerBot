...
func newPost(db *gorm.DB) post {
	...
	_post.Type = field.NewInt32(tableName, "type")
	_post.Content = field.NewString(tableName, "content")
	_post.MentionUserID = field.NewString(tableName, "mention_user_id")
	_post.ReplyPostID = field.NewInt64(tableName, "reply_post_id")
	_post.CreatedTime = field.NewTime(tableName, "created_time")
	_post.UpdatedTime = field.NewTime(tableName, "updated_time")
	_post.DeletedTime = field.NewTime(tableName, "deleted_time")
...
type post struct {
	...
	MentionUserID field.String
	ReplyPostID   field.Int64
...
func (p *post) updateTableName(table string) *post {
	...
	p.MentionUserID = field.NewString(table, "mention_user_id")
	p.ReplyPostID = field.NewInt64(table, "reply_post_id")
...
func (p *post) fillFieldMap() {
	...
	p.fieldMap["mention_user_id"] = p.MentionUserID
	p.fieldMap["reply_post_id"] = p.ReplyPostID
