...
func newUser(db *gorm.DB) user {
	...
	_user.AvatarKey = field.NewString(tableName, "avatar_key")
...
func (u *user) updateTableName(table string) *user {
	...
	u.AvatarKey = field.NewString(table, "avatar_key")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["avatar_key"] = u.AvatarKey
